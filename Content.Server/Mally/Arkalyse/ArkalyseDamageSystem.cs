...
public sealed class ArkalyseDamageSystem : EntitySystem
{
    ...
    {
        _actionSystem.AddAction(uid, ref component.ActionDamageAttackEntity, component.ActionDamageAttack, uid);
    }
    private void OnComponentShutdown(EntityUid uid, ArkalyseDamageComponent component, ComponentShutdown args)
    {
        _actionSystem.RemoveAction(uid, component.ActionDamageAttackEntity);
    }
